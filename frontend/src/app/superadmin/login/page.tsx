          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3.5 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                placeholder="••••••••"
              />
              <button
                type="button"
